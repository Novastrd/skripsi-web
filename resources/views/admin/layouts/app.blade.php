...
<body>
        ...
        <div class="header">
            ...
            <div class="header-left">
                ...
                <a href="admin-dashboard.html" class="logo2">
                    <img src="{{ asset('template/admin/img/logo2.png" width="40" height="40" alt=""') }}">
                </a>
            </div>
            <!-- /Logo -->
            ...
            <div class="page-title-box">
                <h3>Sistem Rekomendasi Pemupukan Padi</h3>
            </div>
            <!-- /Header Title -->
                                    ...
                                    <a href="chat.html">
                                        <div class="list-item">
                                            <div class="list-left">
                                                <span class="avatar">
                                                    <img alt=""
                                                        src="{{ asset('template/admin/img/profiles/avatar-09.jpg') }}">
                                                </span>
                                            </div>
                                            <div class="list-body">
                                    ...
                                    <a href="chat.html">
                                        <div class="list-item">
                                            <div class="list-left">
                                                <span class="avatar">
                                                    <img alt=""
                                                        src="{{ asset('template/admin/img/profiles/avatar-05.jpg') }}">
                                                </span>
                                            </div>
                                            <div class="list-body">
                                    ...
                                    <a href="chat.html">
                                        <div class="list-item">
                                            <div class="list-left">
                                                <span class="avatar">
                                                    <img alt=""
                                                        src="{{ asset('template/admin/img/profiles/avatar-08.jpg') }}">
                                                </span>
                                            </div>
                                            <div class="list-body">
                ...
                <li class="nav-item dropdown has-arrow main-drop">
                    <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <span class="user-img"><img
                                src="{{ asset('template/admin/img/profiles/avatar-21.jpg" alt="') }}">
    ...
    <script>
        function confirmDelete(petaniId) {
